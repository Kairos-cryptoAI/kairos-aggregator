...
from kairos_core.contracts import (
    MarketSnapshot, OrderBookSummary, DerivativesMetrics, TechnicalIndicators, SentimentSignal,
)
...
def test_context_is_compact_and_digested():
    ctx = json.loads(compile_context(
        _snap(),
        [SentimentSignal(source="t", topic="ETF", sentiment=0.8, impact=ImpactDirection.BULLISH)],
    ))
